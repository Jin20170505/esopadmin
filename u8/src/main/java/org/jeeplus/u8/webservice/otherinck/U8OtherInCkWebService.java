package org.jeeplus.u8.webservice.otherinck;
 ...
 * U8其他入库 接口
 */
public final class U8OtherInCkWebService {

    public static final U8WebServiceResult inck(U8OtherInCkMain inCkMain) throws IOException {
        Map<String,Object> param = new LinkedHashMap<>();
        param.put("cCode",inCkMain.getcCode());
        param.put("cWhCode",inCkMain.getcWhCode());
        param.put("dDate",inCkMain.getdDate());
        param.put("crdcode",inCkMain.getCrdcode());
        param.put("cDepCode",inCkMain.getcDepCode());
        param.put("MesCode",inCkMain.getMesCode());
        param.put("cMemo",inCkMain.getcMemo());
        param.put("cMaker",inCkMain.getcMaker());

        List<Map<String, Object>> details = Lists.newArrayList();
        for (U8OtherInCkMx bean:inCkMain.getDetails())
        {
        ...
        soap.append("<YTRdRecord08 xmlns=\"http://tempuri.org/\">");
        soap.append("<jsonstring>"+ss.toString()+"</jsonstring>");
        soap.append("</YTRdRecord08>");
        soap.append("</soap:Body>");
