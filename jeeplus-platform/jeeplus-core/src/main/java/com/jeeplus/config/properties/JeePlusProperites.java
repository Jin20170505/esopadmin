...
public class JeePlusProperites implements Serializable {
	...
	@Value("${ireport.fileFolder}")
	private String ireportFolder;
	...
	public String getIreportFolder() {
		return ireportFolder;
	}

	public void setIreportFolder(String ireportFolder) {
		this.ireportFolder = ireportFolder;
	}
