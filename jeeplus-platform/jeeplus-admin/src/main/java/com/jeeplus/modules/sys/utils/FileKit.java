...
public class FileKit {
    ...
    public static String getTemplateDir(){
        String dir =  JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL  + "template/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }

    public static  String getTemplateUrl(){
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL +  "/template/";
    }
    /**
     * 共享文档物理存储地址
     * @return
    ...
    public static String getAttachmentDir(){
        String dir = JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL + "/param/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }
    ...
    public static String getAttachmentUrl(){
        ...
        return  Servlets.getRequest().getContextPath() + JeePlusProperites.USERFILES_BASE_URL+ "/param/";
    }
