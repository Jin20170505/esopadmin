...
public class TagController extends BaseController {
	 ...
	 */
	@RequiresPermissions("user")
	@RequestMapping(value = "fileUploadAll")
	public String fileUploadAll(String fileValues, String readonly, String uploadPath, String type, String fileNumLimit, String fileSizeLimit, String allowedExtensions, Model model) {
		...
		return "modules/common/fileUploadAll";
	}
	...
	public String fileUploadTemplate(String fileValues, String readonly, String uploadPath, String type, String fileNumLimit, String fileSizeLimit, String allowedExtensions, Model model) {
		String[] fieldValuesArra = fileValues.split("\\|");
		String fileIds = "";
		String fileSizes = "";
		for(String value: fieldValuesArra){
		...
		model.addAttribute("mimeTypes", mimeTypes);
		model.addAttribute("readonly", "true".equals(readonly)?true:false);
		return "modules/common/fileUploadTemplate";
	}
	/**
	 * 文件上传
	 */
