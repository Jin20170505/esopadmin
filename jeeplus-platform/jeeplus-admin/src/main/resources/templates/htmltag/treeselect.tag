<input id="${id}Id" name="${name}"  type="hidden" value="${value!}" data-fun="${callback!}"/>
<div class="input-group">
	<input class="${class!'form-control'}"  id="${id}Name" name="${labelName!}" ${allowInput!false==true?'':'readonly="readonly"'}  type="text" value="${labelValue!}"  type="text">
...
$(document).ready(function(){
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.layer.open({
		    ...
		    content: "${ctx}/tag/treeselect?url="+encodeURIComponent("${url!}")+"&module=${module!}&checked=${checked!}&extId=${extId!}&isAll=${isAll!}&allowSearch=${allowSearch!true}" ,
		    btn: ['确定', '关闭']
