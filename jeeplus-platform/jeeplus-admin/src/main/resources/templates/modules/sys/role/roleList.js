<script>
		$(document).ready(function() {
		                ...
		                columns: [{
	                        ...
	                        events: {
	            		        'click .view': function (e, value, row, index) {
	            		        	jp.openViewDialog('查看角色', '${ctx}/sys/role/form?id=' + row.id,'80%', '70%');
	            		        },
	            		        'click .edit': function (e, value, row, index) {
	            		        	jp.openSaveDialog('编辑角色', '${ctx}/sys/role/form?id=' + row.id,'80%', '70%');
	            		        },
		  ...
		  function add(){
			  jp.openSaveDialog('新建角色', '${ctx}/sys/role/form','80%', '70%')
		  }
		  ...
		  function edit(id){
			  ...
			  jp.openSaveDialog('编辑角色', "${ctx}/sys/role/form?id=" + id,'80%', '70%')
