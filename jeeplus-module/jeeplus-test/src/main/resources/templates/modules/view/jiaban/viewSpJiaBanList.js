...
$(document).ready(function() {
  ...
  function refresh() {
   ...
   //新增表单页面
 function add() {
     jp.openSaveDialog('新增加班报表', "${ctx}/view/jiaban/viewSpJiaBan/form/add",'800px', '500px');
 }
  //编辑表单页面
  function edit(id){
      if(!id){
	  ...
	  jp.openSaveDialog('编辑加班报表', "${ctx}/view/jiaban/viewSpJiaBan/form/edit?id="+id,'800px', '500px');
  }
  //查看表单页面
  function view(id) {
      if(!id){
      ...
      jp.openViewDialog('查看加班报表', "${ctx}/view/jiaban/viewSpJiaBan/form/view?id="+id,'800px', '500px');
  }
</script>