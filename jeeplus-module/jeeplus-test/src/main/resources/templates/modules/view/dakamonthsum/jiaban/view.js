...
$(document).ready(function() {
	...
	$('#viewDakaMonthSumTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/view/dakamonthsum/viewDakaMonthSum/jiaban/data",
  ...
  function refresh() {
   ...
   //新增表单页面
 function add() {
     jp.openSaveDialog('新增月打卡汇总报表', "${ctx}/view/dakamonthsum/viewDakaMonthSum/form/add",'90%', '90%');
 }
  //编辑表单页面
  function edit(id){
      if(!id){
	  ...
	  jp.openSaveDialog('编辑月打卡汇总报表', "${ctx}/view/dakamonthsum/viewDakaMonthSum/form/edit?id="+id,'90%', '90%');
  }
  //查看表单页面
  function view(id) {
      if(!id){
      ...
      jp.openViewDialog('查看月打卡汇总报表', "${ctx}/view/dakamonthsum/viewDakaMonthSum/form/view?id="+id,'90%', '90%');
  }
</script>