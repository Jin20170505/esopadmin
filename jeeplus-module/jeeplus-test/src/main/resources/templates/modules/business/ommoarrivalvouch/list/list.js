...
$(document).ready(function() {
	$('#businessArrivalVouchTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/business/ommoarrivalvouch/businessOmmoArrivalVouch/mxdata",
    ...
    jp.windowOpen('${ctx}/business/ommoarrivalvouch/businessOmmoArrivalVouch/goToTagPrint?rids='+rids,"打印",1200,1200);
}
	//获取选中行
