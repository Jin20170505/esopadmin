		  ...
		  //请求方法
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
                     ...
                     <% }else if(shiro.hasPermission("business:baogong:record:businessBaoGongRecord:view")){ %>
					   if(!value){
			...
			,{
			   ...
			   formatter:  function operateFormatter(value, row, index) {
				   return [
					<% if(shiro.hasPermission("business:baogong:record:businessBaoGongRecord:view")){ %>
