...
$(document).ready(function() {
  ...
  function refresh() {
   ...
   //新增表单页面
 function add() {
     jp.openSaveDialog('新增调薪申请', "${ctx}/oadata/tiaoxin/formmain0153/form/add",'800px', '500px');
 }
  //编辑表单页面
  function edit(id){
      if(!id){
	  ...
	  jp.openSaveDialog('编辑调薪申请', "${ctx}/oadata/tiaoxin/formmain0153/form/edit?id="+id,'800px', '500px');
  }
  //查看表单页面
  function view(id) {
      if(!id){
      ...
      jp.openViewDialog('查看调薪申请', "${ctx}/oadata/tiaoxin/formmain0153/form/view?id="+id,'800px', '500px');
  }
 //子表展示
